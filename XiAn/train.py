...
parser.add_argument('--mask1',type=str,default='data/XiAn_City/mask1.csv',help='mask1 path')
parser.add_argument('--poi',type=str,default='data/XiAn_City/POI_data.csv',help='mask3 path')
parser.add_argument('--poi_vec',type=str,default='data/XiAn_City/Poi.npy',help='mask3 path')
